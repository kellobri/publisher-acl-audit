...
Detect and alert when/if a user/publisher belonging to one business unit (Group) adds a user or group from another business unit (Group) to their content Access Control List (ACL). 
...
- Report: [compliance_check_fail.csv](compliance_check_fail.csv)
